...
module ForemanFogProxmox
  class Proxmox < ComputeResource
    ...
    def client
      ...
      logger.warn(format(('failed to create compute client: %<e>s'), e: e))
      raise e
    end
    ...
    def identity_client
      ...
      logger.warn(format(('failed to create identity client: %<e>s'), e: e))
      raise e
    end
    ...
    def network_client
      ...
      logger.warn(format(('failed to create network client: %<e>s'), e: e))
      raise e
    end
